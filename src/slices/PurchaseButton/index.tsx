  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2
          id="buy-button"
          className="mb-8 scroll-pt-6 text-5xl font-black text-gray-900 uppercase italic md:text-7xl lg:text-8xl"
        >
        ...
        >
          ...
          <div className="relative z-10 flex items-center justify-center gap-6 md:gap-8">
            <span
              ...
              className="text-4xl font-semibold tracking-wide text-gray-900 uppercase italic group-hover:-translate-y-1 motion-safe:transition-transform motion-safe:duration-300 md:text-7xl lg:text-9xl"
            >
              {isPressed ? (
